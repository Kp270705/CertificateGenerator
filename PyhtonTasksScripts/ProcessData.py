from PyhtonTasksScripts.csvFunc import processFile
from PyhtonTasksScripts.generate_pdf import getData
from PyhtonTasksScripts.genZip import zip_folder
...
async def ProcessData(eventname, orgname, certType, certificate_choice, oprchoice, csvPath, logo1Path, logo2Path, organizer1_designation, organizer1Path, organizer2_designation, organizer2Path):  # which get data from operated csv files:
    ...
    from PyhtonTasksScripts.getPath import get_Choice_data

    from PyhtonTasksScripts.redesignTemplate import templatedesign1_2_3, templatedesign4, templatedesign5
    match oprchoice:
